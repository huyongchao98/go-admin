...
See [manual](https://github.com/huyongchao98/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/huyongchao98/go-admin clone, so:
...
Notice: `go get` return `package github.com/huyongchao98/go-admin: no Go files in /go/src/github.com/huyongchao98/go-admin` is normal.
