...
[Comment the issue to tell us](https://github.com/huyongchao98/go-admin/issues/71).
...
More framework examples: [https://github.com/huyongchao98/go-admin/tree/master/examples](https://github.com/huyongchao98/go-admin/tree/master/examples)
